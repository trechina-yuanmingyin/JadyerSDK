 ...
 */
public class InCustomServiceEventMsg extends InEventMsg {
	/**
	 * 接入会话
	 */
	...
	public InCustomServiceEventMsg(String toUserName, String fromUserName, long createTime, String msgType, String event) {
