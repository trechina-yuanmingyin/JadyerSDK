...
<script>
function deploy(){
	$.post("${ctx}/user/menu/weixin/create/json",
...
<div class="c_content">
	<table class="tab_head tab_in tab_list2" width="100%">
		...
		<tr>
			<td>
				<span>注：以上限制来自<a href="http://mp.weixin.qq.com/wiki/13/43de8269be54a0a6f64413e4dfa94f39.html" target="_blank" style="color:blue;">微信公众平台。</a></span>
	...
	<table class="tab_in2" width="100%">
		...
		<tr>
			...
			<td>
				...
				<script src="${ctx}/js/codeformat/json/c.js"></script>
